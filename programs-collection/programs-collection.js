...
var listPrograms = [
  ...
  new Program("Visual Fourier", "processing js", "https://www.openprocessing.org/sketch/503560", "http://i.imgur.com/gREs77f.png",
              "The Fourier Transform is arguably the most useful math ever developed. Yet, few understand it. Based off of 3blue1brown's videos on the topic, behold a visual interpretation of the Fourier Transform."),
  ...
  new Program("Neural Network", "processing js", "https://www.openprocessing.org/sketch/467182", "http://i.imgur.com/KGm1aun.png",
              "Click to train a neural network to predict the output of the sine function. Change its structure or task on lines 161 and 166-167."),
  new Program("Gravity Pong", "javascript", "https://www.arongil.com/gravity-pong", "http://i.imgur.com/kIKQL68.png",
  ...
  new Program("Minesweeper and Solver", "javascript", "https://www.arongil.com/minesweeper", "http://i.imgur.com/gGx88Z8.png",
  ...
  new Program("Calculator", "javascript", "https://www.arongil.com/calculator", "http://i.imgur.com/zx8A4pc.png",
              "A Calculator built using LMath, a custom library of math functions that I built from scratch, and an advanced parser."),
  new Program("Void", "javascript", "https://www.arongil.com/void", "http://i.imgur.com/GJUcZOr.jpg",
  ...
  new Program("Waves", "javascript", "https://s.codepen.io/Arongil/debug/zwBEMO", "http://imgur.com/kDxPBNc.png",
  ...
  new Program("Ooze", "javascript", "https://s.codepen.io/Arongil/debug/eWNZXE/YvAgOPaXQbDA", "http://i.imgur.com/N8B4sg6.png",
  ...
  new Program("Bird Breaker", "javascript", "https://www.arongil.com/bird-breaker", "http://i.imgur.com/UvM603K.png",
  ...
  new Program("Chess", "python", "https://trinket.io/library/trinkets/d56d41fffa", "http://imgur.com/NEE7lap.png",
  ...
  new Program("Grapher", "python", "https://trinket.io/library/trinkets/6830489b27", "http://i.imgur.com/QLd8BnJ.png",
  ...
  new Program("Gravity Crash", "python", "https://trinket.io/library/trinkets/2534a0e391", "http://i.imgur.com/yJRw9re.png",
             "Hit balls into holes, just like billiards, but use little black holes to move the white ball, not a stick! With realistic collisions, this game is very fun to play. It's also the largest Python program I had made, pulling from lots of the vector math from Vector Playground by using a python Vector2D class. The Vector2D class is used in almost every program since then, because it's so useful and easy. (The Coderschool wrote about this: https://www.thecoderschool.com/blog/newtons-gravity-as-coded-by-an-11yo-student)"),
